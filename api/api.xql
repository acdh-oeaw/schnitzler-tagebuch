...
declare 
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/about")
...
function api:api-about($format as xs:string*, $pageNumber as xs:integer*, $pageSize as xs:integer*) {
    let $endpoints := 
        <result>
            <ep>
                <url>/schnitzler-tagebuch/api/collections</url>
            ...
            <ep>
                <url>{"/schnitzler-tagebuch/api/collections/{$collection}"}</url>
...
declare 
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/collections")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/collections/{$collection}")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/entities")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/entities/{$id}")
...
declare
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/entity-types")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/schnitzler-tagebuch/api/entity-types/{$id}")
