...
feather.replace(),anchors.add(".anchored"),jQuery(function(r){"use strict";r(window).on("load",function(){r(".card-wrapper").isotope({itemSelector:".card",masonry:{columnWidth:".card", horizontalOrder: true}})})});
