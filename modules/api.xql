...
import module namespace app="http://www.digital-archiv.at/ns/schnitzler-tagebuch/templates" at "app.xql";
...
declare 
    %rest:GET
    %rest:path("/schnitzler-tagebuch/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/schnitzler-tagebuch/{$collection}/{$id}/{$format}")
